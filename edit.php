            ...
            <form action="update.php?id=<?= $id ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="<?= $val['nama_lengkap'] ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="nim" class="col-sm-2 col-form-label">NIM</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nim" name="nim"  value="<?= $val['nim'] ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="program_studi" id="program_studi">
                                ...
                                ?>
                                    <option value="<?= $row['ps_id'] ?>" <?php if ($row['ps_id']== $val['program_studi']) echo 'selected';?> ><?= $row['program_studi'] ?></option>
                                <?php endwhile; ?>
                            </select>
                        </div>
                    </div>
